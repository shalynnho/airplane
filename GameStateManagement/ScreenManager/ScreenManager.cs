...
namespace GameStateManagement
{
    ...
    public class ScreenManager : DrawableGameComponent
    {
        ...
        int currentLevel;
        int currentScore;
        GameplayScreen currentLevelScreen;
        ...
        protected override void LoadContent()
        {
            ...
            gameplayMusic = content.Load<Song>("music");
        ...
        public Song getMenuMusic()
        {
            return menuMusic;
        }

        public Song getGameplayMusic()
        {
        ...
        public void loadNextLevelScreen()
        {
            if (currentLevel == 1)
            {
                LoadingScreen.Load(this, true, new GameplayScreen("Content/LevelTwoMap.txt", "Content/LevelTwoData.txt", 2, true, currentScore));
              

            }
            else if (currentLevel == 2)
            {
                LoadingScreen.Load(this, true, new GameplayScreen("Content/LevelThreeMap.txt", "Content/LevelThreeData.txt", 3, true, currentScore));
            }
            else if (currentLevel == 3)
            {
                LoadingScreen.Load(this, true, new GameplayScreen("Content/LevelFourMap.txt", "Content/LevelFourData.txt", 4, true, currentScore));
            }
            else if (currentLevel == 4)
            {
                LoadingScreen.Load(this, true, new GameplayScreen("Content/LevelFiveMap.txt", "Content/LevelFiveData.txt", 5, true, currentScore));
            }
            else if (currentLevel == 5)
            {
                LoadingScreen.Load(this, true, new BackgroundScreen(), new MainMenuScreen());
                MediaPlayer.Stop();
                MediaPlayer.Play(menuMusic);
            }
            loadingLevel = false;
